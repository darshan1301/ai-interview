...
exports.setInterviewSession = setInterviewSession;
exports.getInterviewSession = getInterviewSession;
exports.clearAllInterviewSessions = clearAllInterviewSessions;
...
// Save
async function setInterviewSession(id, manager) {
    await connect();
    const state = {
...
async function getInterviewSession(id) {
    ...
    const mgr = new interviewManager_1.InterviewManager(parsed.questions, parsed.user);
    mgr.status = parsed.status;
    mgr.currentIndex = parsed.currentIndex;
    return mgr;
}
//clear all
async function clearAllInterviewSessions() {
    await connect();
